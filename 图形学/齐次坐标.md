...
- [3. affine transformation](#3-affine-transformation)
  - [3.1. linear transformation](#31-linear-transformation)
    ...
    - [3.1.4. Rotation](#314-rotation)
  - [3.2. translation transformation](#32-translation-transformation)
  - [3.3. RT](#33-rt)
- [4. 变化可逆](#4-变化可逆)
- [5. 顺序](#5-顺序)
- [6. row/column major](#6-rowcolumn-major)
...
#### 左乘
# 相当于 rays_d = (c2w[None, None, :3,:3] @ dirs[..., None]).squeeze(-1)
#### 右乘
# 相当于 rays_d = (dirs[..., None, :] @ c2w[:3,:3].T).transpose(0,1,3,2).squeeze(-1)
