![图 1](../../images/f8ea386a62b1d7390d955dc287b7f8e8608efe1252ae3d73e529edcce168d2d5.png)  

Generator: 分布到分布的映射，将一个简单的分布中的噪声样本`z`，变成了一个复杂分布里的样本`G(z)`。

> 我感觉是 one-to-many的问题，或者 mean 值问题

![图 2](../../images/fd3f2c2820fa7b36b755a06b7c9723d93da25b6e2c53663378f17540345a039e.png)  


MLP回归网络会生成同时既向左又向右的many结果，但正确应该是只同时出现一个方向。

![图 3](../../images/6b75ab4e9336348c66bc17c8dfe0545d786918f501a8b5d2e09004b6faf8bc4e.png)  
